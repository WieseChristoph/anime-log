...
const AnimeEdit = ({
	...
	function updateArray(arrayName: string, array: any[]): void {
		setAnime((prevAnime) => ({
			...prevAnime,
			[arrayName]: array,
		}));
	...
	return (
		...
		>
			<div className="flex flex-col sm:flex-row">
				...
				>
					<Image
						src={anime.imageUrl ? anime.imageUrl : placeholderImage}
						alt={anime.title}
						layout="intrinsic"
						height={IMAGE_HEIGHT}
						width={IMAGE_WIDTH}
				...
				>
					...
					<div className="flex flex-col border-l border-black dark:border-white px-2">
						<div className="basis-1/3">
							<div className="font-semibold mr-2">Seasons</div>
							<ListInput
			...
			<div className="columns-1 absolute top-1 right-1">
				...
				<button
					onClick={() => onSaveButtonClick(anime)}
