...
type AnimeSkeletonPropsType = {
    index: number;
};

const AnimeSkeleton = ({ index }: AnimeSkeletonPropsType) => {
    return (
        <motion.div
        ...
        >
            <div className="flex animate-pulse flex-col sm:flex-row">
                {/* Image */}
                <div className={`flex h-52.5 w-37.5 items-center justify-center rounded bg-gray-300 dark:bg-gray-700`}>
                    <svg
                ...
                <div className={`sm:grid-rows-1] grid flex-1 grid-cols-1 grid-rows-2 py-2 sm:grid-cols-2`}>
                    ...
                    <div className="flex flex-col overflow-hidden px-2">
                        <div>
                            {/* Rating */}
                            <div className="float-right mt-1 mr-2 h-4 w-12.5 rounded-full bg-gray-200 dark:bg-gray-700" />
                            {/* Title */}
                            <div className="mt-1 mb-2 h-4 max-w-50 rounded-full bg-gray-200 dark:bg-gray-700" />
                            {/* Start Date */}
                            <div className="mb-1 h-3 max-w-25 rounded-full bg-gray-200 dark:bg-gray-700" />
                            {/* Updated At */}
                            <div className="mb-2 h-2 max-w-37.5 rounded-full bg-gray-200 dark:bg-gray-700" />
                        ...
                        <div className="h-full space-y-2.5 overflow-y-auto pt-2">
                            ...
                            <div className="flex w-full max-w-120 items-center space-x-2">
                                <div className="h-2.5 w-full rounded-full bg-gray-200 dark:bg-gray-700"></div>
                                <div className="h-2.5 w-full rounded-full bg-gray-300 dark:bg-gray-600"></div>
                                <div className="h-2.5 w-24 rounded-full bg-gray-300 dark:bg-gray-600"></div>
                            </div>
                            <div className="flex w-full max-w-100 items-center space-x-2">
                                <div className="h-2.5 w-full rounded-full bg-gray-300 dark:bg-gray-600"></div>
                            ...
                            <div className="flex w-full max-w-110 items-center space-x-2">
                                <div className="h-2.5 w-32 rounded-full bg-gray-300 dark:bg-gray-600"></div>
                                <div className="h-2.5 w-24 rounded-full bg-gray-300 dark:bg-gray-600"></div>
                                <div className="h-2.5 w-full rounded-full bg-gray-200 dark:bg-gray-700"></div>
                            </div>
                            <div className="flex w-full max-w-90 items-center space-x-2">
                                <div className="h-2.5 w-full rounded-full bg-gray-300 dark:bg-gray-600"></div>
                                <div className="h-2.5 w-80 rounded-full bg-gray-200 dark:bg-gray-700"></div>
                                <div className="h-2.5 w-full rounded-full bg-gray-300 dark:bg-gray-600"></div>
                            </div>
                    ...
                    <div className="flex flex-col border-black px-2 sm:border-l dark:border-white">
                        <div className="basis-1/3">
                            <div className="mt-1 mb-2 h-4 max-w-25 rounded-full bg-gray-200 dark:bg-gray-700" />
                            <div className="h-4 rounded-full bg-gray-200 dark:bg-gray-700" />
                        </div>
                        <div className="basis-1/3">
                            <hr className="border-black dark:border-white" />
                            <div className="mt-1 mb-2 h-4 max-w-18.75 rounded-full bg-gray-200 dark:bg-gray-700" />
                            <div className="h-4 rounded-full bg-gray-200 dark:bg-gray-700" />
                        </div>
                        <div className="basis-1/3">
                            <hr className="border-black dark:border-white" />
                            <div className="mt-1 mb-2 h-4 max-w-12.5 rounded-full bg-gray-200 dark:bg-gray-700" />
                            <div className="h-4 rounded-full bg-gray-200 dark:bg-gray-700" />
                        </div>
                    </div>
                </div>
