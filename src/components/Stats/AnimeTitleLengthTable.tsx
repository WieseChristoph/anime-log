    ...
    return (
        <table className="mt-4 h-[90%] w-full text-center">
            <thead className="text-xs uppercase text-gray-700 dark:text-gray-400">
                <tr>
                    <th className="bg-gray-50 py-3 px-6 dark:bg-gray-900">
                        Rank
                    </th>
            ...
            <tbody>
                {anime.slice(0, 5).map((a, i, array) => (
                    ...
                    >
                        <th className="whitespace-nowrap bg-gray-50 py-4 px-6 font-medium text-gray-900 dark:bg-gray-900 dark:text-white">
                            {i + 1}
                        </th>
                        <td className="py-4 px-6">{a.title}</td>
                        <td className="whitespace-nowrap bg-gray-50 py-4 px-6 font-medium text-gray-900 dark:bg-gray-900 dark:text-white">
                            {a.title.length}
                        </td>
                    </tr>
                ))}
