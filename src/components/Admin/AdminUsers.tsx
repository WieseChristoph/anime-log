        ...
        <div className="my-4 grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3">
            {getAllUsers.data?.map((user, userIndex) => (
                <Disclosure key={userIndex} as="div" className="grow">
                    <Disclosure.Button className="ui-not-open:rounded-b ui-not-open:border-b flex w-full items-center gap-2 rounded-t border-x border-t border-gray-300 bg-gray-200 p-4 py-2 shadow-md dark:border-slate-700 dark:bg-slate-800">
                        <ImageWithFallback
